...
if((isset($_POST['cty']) == true) && ($_POST['llt']!= '1')){
$ctysel = $_POST['cty'];
$ctysel = addslashes($ctysel);

$query = $query . " where book_category.category_id = " . $searchcat . " and item_desk.city = '".$ctysel."' and item_desk.locality ='".$llt."'  group by book_category.category_name order by book_category.section_id";
} else {
$ctysel = $_POST['cty'];
$ctysel = addslashes($ctysel);
