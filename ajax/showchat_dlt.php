...
$result = $db->prepare("select message_id,fromid,from_name,message,toid,to_name from message_list where (fromid = ? or fromid =?) and (toid =? or toid=?) order by message_id");
