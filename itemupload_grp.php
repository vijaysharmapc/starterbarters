...
<meta name="date" content="2015-03-08T00:54:42+0530" >
...
$stmt->execute(array('',"$section_id","$category1","$title","$ihave","$iwant","$other","$city","$varg","$dir",'',''));
...
<div id="main">
<form action="itemupload_grp.php" method="post">
